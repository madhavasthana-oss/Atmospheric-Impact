...
\textbf{0. Presence.} Be genuinely outward. Without this, nothing else in the 
framework operates.

\textbf{1. Genuine Origin.} Say what is real. If the origin is not genuine, 
the quadrant does not matter.

\textbf{2. Non-interference.} Express the thought at whatever level of closure it 
actually reached. Do not add meaning that had not arrived. Do not close meaning that 
had not resolved.
