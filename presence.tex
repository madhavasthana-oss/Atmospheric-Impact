...
If a fragment forms but does not belong, it is not replaced by effort. The man remains present, and the field continues resolving. Often, a more accurate expression surfaces on its own — not as a correction, but as what the moment was actually carrying beneath the first fragment.
\begin{calloutbox}
