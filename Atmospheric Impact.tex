...
If everything in this framework is compressed into action, it reduces to three conditions.

\subsection{Presence Over Everything}

Feel the room before you act.

Attention must be genuinely outward — off yourself and onto what is actually present.  
Expression follows from perception. If you are not seeing clearly, anything you say will be constructed.

Presence is not a technique. It is the condition for everything that follows.
...
\begin{itemize}
    \item \textbf{\hyperref[sec:presence]{Presence}} — Are you actually perceiving what is in front of you?
    \item \textbf{\hyperref[subsec:origin_and_closure]{Genuine}} — Is what you are about to say real?
    \item \textbf{\hyperref[subsec:stopping_point]{Non-interference}} — Do not add, polish, or complete what has not formed.
\end{itemize}

Say what is real.  
Stop where the meaning actually sits.

Do not close what has not resolved.  
Do not leave open what has already closed.

\subsection{The Calibration Protocol}

\hyperref[subsec:calibration_protocol]{Calibration} follows a methodology. Stay inside the loop:
...
\begin{itemize}
    \item Establish baseline before interpreting signals.
    \item Use \textbf{Graze} to test — something real, placed lightly, then left.
    \item Allow \textbf{Gradual} only if she moves toward what was placed.
    \item Respect pacing — never move before she finishes.
\end{itemize}

If she moves toward you, continue.  
If she pauses, hold.  
If she pulls back, reduce.

Do not force completion. Let meaning build where it actually sits.

\subsection*{Irreducible Core}

If everything above is reduced further:
...
\begin{calloutbox}
If you find yourself trying to apply this, you have already left it.
\end{calloutbox}
...
% ── 6.9 The Calibration Protocol ─────────────────────────────────────────────

\subsection{The Calibration Protocol}\label{subsec:calibration_protocol}
\input{calibration_protocol.tex}
