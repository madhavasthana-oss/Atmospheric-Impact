...
\section{Verbal Presence}

Something happens. A thought or feeling is born --- incomplete, real, not yet resolved 
into a label. Less \textit{``you're pretty''} and more 
\textit{``the way you look today\ldots it stands out to me.''} The difference is not 
politeness or style. One has already been collapsed into a verdict. 
The other is still carrying the shape of what was actually noticed.

\subsection{Selection}

Selection is the only conscious movement in this sequence --- and even then, barely. 
It is not deliberate in the way planning is. It is presence making a quiet judgment: 
of the several things forming right now, which one belongs to this moment and this person. 
Not the most impressive. Not the safest. The one that is actually true right now.

\subsection{Release}

Release it at whatever level of closure it reached. Not elevated to sound more 
significant. Not softened to sound safer. At the register it arrived in---because that 
register is part of the meaning.

The risk of polishing is that polishing is, by its nature, construction. You refine 
something to land better, produce a cleaner effect---and by any effect produced, that 
construction negates itself. The receiver does not feel the thought. They feel the attempt.

So say it. Stop where it stopped. Leave it at the temperature it came from.

\bigskip
\noindent That is verbal presence. Not a technique for expression. A description of 
what expression looks like when nothing has been done to it.
